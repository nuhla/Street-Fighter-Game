...
public class mFlipper extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			im2.setImageResource(R.drawable.gradiant2);
			im2.setLayoutParams(new GridView.LayoutParams(85, 85));
			im2.setScaleType(ImageView.ScaleType.FIT_CENTER);
			im2.setId(1);
			im2.setPadding(2, 2, 2, 2);
			
			im.setImageResource(mThumbIds[position]);
